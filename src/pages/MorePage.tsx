...
import { Wrench, DollarSign, FileText, Settings, LogOut, ChevronRight, Package, Repeat } from 'lucide-react'
      ...
      <div className="px-4 space-y-4 pb-4">
        {sections.map(section => (
          <div key={section.title}>
            <p className="text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-2">{section.title}</p>
